    ...
    <div class="card p-4">
      ...
      <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-md-8">
              <div class="panel">
                <input type="text" class="form-control mb-3" name="listing_title" placeholder="Enter title here">
                ...
                <textarea id="listing-description-textarea" name="listing_description"></textarea>
              </div>
              ...
              <div class="card mt-3">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group mb-3">
                      ...
                      <div class="custom-file">
                        <input type="file" name="brand_logo" class="custom-file-input" id="inputGroupFile01">
                  ...
                  <div class="form-group mt-4">
                    ...
                    <input type="text" name="business_tagline" id="" class="form-control">
                  ...
                  <div class="form-group mt-4">
                    ...
                    <div class="input-group mb-3">
                      ...
                      <div class="custom-file">
                        <input type="file" name="background_image" class="custom-file-input" id="inputGroupFile01">
                        <label class="custom-file-label" for="inputGroupFile01">Choose file</label>
                      </div>
                    </div>
                  ...
                  <div class="row mt-4">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="tel" name="whatsapp_number" id="" class="form-control">
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="">Website</label>
                        <input type="email" name="website" id="" class="form-control">
                      </div>
                    </div>
                  </div>
                ...
                <script>
                  function addHourRow() {
                    ...
                    row.innerHTML = `
                      ...
                      <input type="hidden" name="start_times[]" value="${start}">
                      <input type="hidden" name="end_times[]" value="${end}">
                      <input type="hidden" name="is_24_hours[]" value="${is24 ? 1 : 0}">
                    `;
                ...
                <button type="button" class="btn btn-sm btn-dark" onclick="addSocialLink()">
                ...
                <div class="form-group">
                  ...
                  <select name="listing_type" class="form-control membership-from-select-field" id="">
                ...
                <script>
                  document.querySelector('.custom-file-input').addEventListener('change', function(e) {
                    ...
                    e.target.nextElementSibling.innerText = fileNames;
                  });
                </script>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <select name="price_status" class="form-control membership-from-select-field" id="">
                ...
                <div class="card-body">
                  @foreach($categories as $ca)
                    <div class="d-flex align-items-center">
                      <input value="{{ $ca->id }}" name="listing_categories[]" type="checkbox"><span class="ml-2">{{ $ca->categories_name }} </span>
                    </div>
              ...
              <div class="card mt-3">
                ...
                <div class="card-body">
                  @foreach($locations as $la)
                    <div class="d-flex align-items-center">
                      <input value="{{ $la->id }}" name="listing_locations[]" type="checkbox"><span class="ml-2">{{ $la->location_name }} </span>
                    </div>
