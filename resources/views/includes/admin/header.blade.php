...
<head>
    ...
    <title>Cardiff Third Sector Council - Dashboard</title>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('adminDashboardView') }}">
                <div class="sidebar-brand-icon rotate-n-0">
                    <img src="https://membership.c3sc.org.uk/wp-content/uploads/2023/07/c3sc-logo.png" height="60" alt="">
                </div>
                <div class="sidebar-brand-text mx-3"><strong>Administrative</strong> Dashbaord</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseOne" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ route('abandonedMembersList') }}">Pending Members</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ route('listingListView') }}">Listing List</a>
                        <a class="collapse-item" href="">Waiting List</a>
                        <a class="collapse-item" href="">Archived List</a>
                        <a class="collapse-item" href="">Pending List</a>
            ...
            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                ...
                <a class="dropdown-item d-flex align-items-center" href="#">
                    <div class="dropdown-list-image mr-3">
                        <img class="rounded-circle" lazyload src="img/undraw_profile_1.svg"
                            alt="...">
        ...
        <li class="nav-item dropdown no-arrow">
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                ...
                <span class="mr-2 d-none d-lg-inline text-gray-600 small">
                    @if(session('admin_firstname'))
                        {{ session('admin_firstname') }}
                    @else
                        {{ session('admin_username') }}
                    @endif
                </span>
                <img class="img-profile rounded-circle"
                    src="https://membership.c3sc.org.uk/wp-content/uploads/2023/07/noun-alzheimer-disease-4798804-ffffff-1.svg">
            </a>
